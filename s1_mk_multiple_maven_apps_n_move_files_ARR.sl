...
srun python s1_mk_multiple_maven_apps_n_move_files_ARR.py -idx "${SLURM_ARRAY_TASK_ID}" -n 577 -s ../my_codesnippet_analysis/pmdpasscodesnippets_java -crd ../my_codesnippet_analysis/CheckStyle1 -ucrd -pd mvn_apps -upd -libs checks_lib -rvaf