...
# srun python s1_mk_multiple_maven_apps_n_move_files_ARR.py -idx "${SLURM_ARRAY_TASK_ID}" -n 577 -s ../my_codesnippet_analysis/pmdpasscodesnippets_java -pd ../my_codesnippet_analysis/CheckStyle3/mvn_apps -upd -libs ../my_codesnippet_analysis/CheckStyle3/checks_lib -rvaf

# srun python s1_mk_multiple_maven_apps_n_move_files_ARR.py -idx "${SLURM_ARRAY_TASK_ID}" -n 577 -s ../my_codesnippet_analysis/pmdpasscodesnippets_java -crd ../my_codesnippet_analysis/CheckStyle3 -ucrd -pd mvn_apps -upd -libs checks_lib -rvaf
...
#file_location = os.path.join('../my_codesnippet_analysis/pmdpasscodesnippets_java', '*.java')
...
def update_pom_xml(
    ...
    ######### update the 'properties' source and target text tag with the checkstyle requirements ##########
    # <properties>
    properties = root[6]
...
def create_mvn_app_n_copy_multiple_java_files_to_analyse():
    ...
    #e.g., ../my_codesnippet_analysis/CheckStyle1/mvn_apps
    #or mvn_apps
    parent_dest_full_path = parent_dest_path
    
    #e.g., ../my_codesnippet_analysis/CheckStyle1/mvn_apps/checks_lib
    ...
    if use_comm_root_dir == True and use_parent_dest_path == True:
        ...
        #e.g., ../my_codesnippet_analysis/CheckStyle1/checks_lib
        ...
        #e.g., ../my_codesnippet_analysis/CheckStyle1/checks_lib
        lib_full_path = '{}/{}'.format(comm_root_dir, lib_path)
        #e.g., ../my_codesnippet_analysis/CheckStyle/mvn_apps/my-javacodeanalysis-app0
    ...
    if rm_auto_gen_file == True:
        ...
        #remove_dir_if_exist_cmd = 'cd ../my_codesnippet_analysis/CheckStyle3/mvn_apps/; rm -rf my-javacodeanalysis-app0
    ...
    # create mvn app 
    #maven_app_cmd = 'cd ../my_codesnippet_analysis/CheckStyle3/mvn_apps/; mvn archetype:generate -DgroupId=myjavacodeanalysis -DartifactId=my-javacodeanalysis-app0 -DarchetypeArtifactId=maven-archetype-quickstart -DarchetypeVersion=1.4 -DinteractiveMode=false'
    ...
    #e.g., fmt_pom_xml_cmd = 'cd ../my_codesnippet_analysis/CheckStyle3/mvn_appsa/my-javacodeanalysis-app0; xmllint --format pom.xml > pom_fmt.xml'
    ...
    #remove the pom.xml file 
     #e.g., rv_pom_xml_cmd = 'cd ../my_codesnippet_analysis/CheckStyle3/mvn_appsa/my-javacodeanalysis-app0; rm pom.xml'
    ...
    #rename the pom_fmt.xml to pom.xml file
     #e.g., rm_pom_xml_cmd = 'cd ../my_codesnippet_analysis/CheckStyle3/mvn_appsa/my-javacodeanalysis-app0; mv pom_fmt.xml pom.xml'
    ...
    #cp_checks_xml_cmd = 'cp checks_lib/google_checks.xml ../my_codesnippet_analysis/CheckStyle3/mvn_appsa/my-javacodeanalysis-app0'
    ...
    #e.g., rv_def_java_app_file_cmd = 'rm ../my_codesnippet_analysis/CheckStyle3/mvn_apps/my-javacodeanalysis-app0/src/main/java/myjavacodeanalysis/App.java'
    ...
    #e.g dest_dir = '../my_codesnippet_analysis/CheckStyle1/mvn_apps/my-javacodeanalysis-app0/src/main/java/myjavacodeanalysis'
